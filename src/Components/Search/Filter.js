...
const Filter = ({ changeFilter, filters, handleCloseFilter }) => {
  ...
  const handleDiscountFilterChange = (event) => {
    if (!filter_discounts.includes(event.target.value))
      ...
      setFilter_discount(
        filter_discounts.filter((discount) => discount !== event.target.value)
      );
  ...
  const handleBrandFilterChange = (event) => {
    if (!filter_brands.includes(event.target.value))
      ...
      setFilter_Brand(
        filter_brands.filter((brand) => brand !== event.target.value)
      );
  ...
  const handleCategoryFilterChange = (event) => {
    if (!filter_categories.includes(event.target.value))
      ...
      setFilter_categories(
        filter_categories.filter((category) => category !== event.target.value)
      );
    ...
    <div className={classes.root}>
      <Grid container direction="column">
        <Grid
          ...
          direction="row"
          alignItems="center"
          className={classes.filterHeadRow}
        >
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          name={discount}
                          checked={
                            filter_discounts !== null &&
                            filter_discounts.includes(discount)
                          }
                          className={classes.checkbox}
                        />
                      }
